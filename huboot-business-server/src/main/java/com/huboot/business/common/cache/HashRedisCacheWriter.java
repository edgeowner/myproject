 ...
 * {@link HashRedisCacheWriter} can be used in
...
public class HashRedisCacheWriter implements RedisCacheWriter {
	 ...
	 */
	public HashRedisCacheWriter(RedisConnectionFactory connectionFactory) {
	 ...
	 * @param connectionFactory must not be {@literal null}.
	 */
	public HashRedisCacheWriter(RedisConnectionFactory connectionFactory, RedisSerializer<String> stringSerializer) {
