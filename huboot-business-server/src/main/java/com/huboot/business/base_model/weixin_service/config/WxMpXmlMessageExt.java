...
@XStreamAlias("xml")
@Data
public class WxMpXmlMessageExt implements Serializable {
  ...
  public static WxMpXmlMessageExt fromXml(String xml) {
    //修改微信变态的消息内容格式，方便解析
    xml = xml.replace("</PicList><PicList>", "");
    return XStreamTransformerExt.fromXml(WxMpXmlMessageExt.class, xml);
  }

  public static WxMpXmlMessageExt fromXml(InputStream is) {
    return XStreamTransformerExt.fromXml(WxMpXmlMessageExt.class, is);
  }
   ...
   */
  public static WxMpXmlMessageExt fromEncryptedXml(String encryptedXml,
  ...
  public static WxMpXmlMessageExt fromEncryptedXml(InputStream is,
                                                   WxMpConfigStorage wxMpConfigStorage, String timestamp, String nonce,
                                                   String msgSignature) {
    try {
   ...
   *
   */
  public static class XStreamTransformerExt {
    private static final Map<Class<?>, XStream> CLASS_2_XSTREAM_INSTANCE = new HashMap<>();

    static {
      registerClass(WxMpXmlMessageExt.class);
    }
