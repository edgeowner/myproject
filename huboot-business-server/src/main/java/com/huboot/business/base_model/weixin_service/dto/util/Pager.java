...
public class Pager<E> implements Serializable {
    ...
    public Pager(Page<E> page) {
        ...
        this.rowsCount = Integer.valueOf(page.getTotalElements() + "");
        this.pageItems = page.getContent();
        int pageCount = (int) Math.ceil((double) rowsCount / (double) pageSize);
    ...
    public static Pager empty(int pageSize) {
        return new Pager(1, pageSize, 0, new ArrayList());
    }
