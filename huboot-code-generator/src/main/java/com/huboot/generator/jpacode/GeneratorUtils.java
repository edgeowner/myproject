...
public class GeneratorUtils {
    ...
    public void generator(String servicemodule, String tablename, String classname, String moduleName,
        ...
        String daoBasePackage = "com.xiehua.business."+servicemodule+"."+moduleName+".dao";
        String entityBasePackage = "com.xiehua.business."+servicemodule+"."+moduleName+".entity";
        String serviceBasePackage = "com.xiehua.business."+servicemodule+"."+moduleName+".service";
        String repositoryBasePackage = "com.xiehua.business."+servicemodule+"."+moduleName+".repository";
        String dtoBasePackage = "com.xiehua.business."+servicemodule+"."+moduleName+".dto";
        String controllerBasePackage = "com.xiehua.business."+servicemodule+"."+moduleName+".controller";
    ...
    private void genertorDao(Context context, String classname) throws FileNotFoundException,
        ...
        // 生成dao层
        String type = "dao";
        Template template = Velocity.getTemplate("com/xiehua/generator/jpacode/" + type + ".vm");
        ...
        type = "dao.impl";
        template = Velocity.getTemplate("com/xiehua/generator/jpacode/" + type + ".vm");
    ...
    private void genertorService(Context context, String classname)
        ...
        // 生成dao层
        Template template = Velocity.getTemplate("com/xiehua/generator/jpacode/" + type
                + ".vm");
