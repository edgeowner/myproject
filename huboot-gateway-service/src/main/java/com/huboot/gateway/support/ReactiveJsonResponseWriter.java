package com.huboot.gateway.support;
...
public class ReactiveJsonResponseWriter {
    ...
    public Mono<Void> print() {
        ...
        DataBuffer buffer = response.bufferFactory().wrap(JsonUtil.buildNormalMapper().toJson(exceptionResponse).getBytes(Charset.defaultCharset()));
