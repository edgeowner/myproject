...
public abstract class DefaultBaseDao{
     ...
     * @throws Exception
     */
    public <R> ShowPageImpl<R> queryForPager(StringBuilder sql, Class<R> resultClazz, Map<String, Object> params, Integer pageIndex, Integer pageSize){
        ...
        int count = getPagetCount(sql.toString(), params);
        if(count == 0){
     ...
     * @return
     */
    public int getPagetCount(String sql, Map<String, Object> params){
        ...
        return this.getCount(countSql, params);
    }
     ...
     * @return
     */
    public int getCount(String countSql, Map<String, Object> params) {
    ...
    public <R> ShowPageImpl<R> getShowPage(List<R> result, int count, int pageIndex, int pageSize){
        Pageable pageable = PageRequest.of(pageIndex, pageSize);
        ShowPageImpl<R> pager = new ShowPageImpl<>(result, pageable, count);
        return pager;
    }
