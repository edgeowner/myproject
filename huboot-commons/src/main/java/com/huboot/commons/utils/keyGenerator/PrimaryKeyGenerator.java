package com.huboot.commons.utils.keyGenerator;
...
//	private static final Integer WORKER_ID = 1;
	private SequencePrimaryKeyGenerator(){
		try {
//			 PropertyConfigurer feign = (PropertyConfigurer) SpringContextUtil.getBean("propertyConfigurer");
//			 worker = new IdWorker(Integer.parseInt(feign.getProperty("primaryKey.workId")));
