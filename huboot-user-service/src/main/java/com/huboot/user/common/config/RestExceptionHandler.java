 ...
 * 说明 ：全局异常处理
 * **/
@RestControllerAdvice("com.xiehua")
public class RestExceptionHandler {
    ...
    public ExceptionResponse exception(BizException exception, HttpServletRequest request) {
    ...
    public ExceptionResponse exception(Exception exception, HttpServletRequest request) {
    ...
    public ExceptionResponse exception(BizHystrixBadRequestException exception, HttpServletRequest request) {
